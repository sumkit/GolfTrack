...
def stats(request):
	...
	if len(rounds) = 0: 
		...
		context['handicap']=0
		context['parcount']=0
		context['birdiecount']=0
		context['bogeycount']=0
		context['eaglecount']=0
		context['doublecount']=0
		context['otherscount']=0
		context['averages']=0
		context['averages1']=0
		context['FIRav'] = 0
		context['GIRav'] = 0
	...
	for round in rounds:
		...
		par3sum += round.get_hole_average(3)
		par4sum += round.get_hole_average(4)
		par5sum += round.get_hole_average(5)
		FIRs += round.fairways
		GIRs += round.greens
		putts += round.putts()
